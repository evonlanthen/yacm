...
callViewAction getViewInitActionRun(void) {
	return &run;
}

callViewAction getViewInitActionActivate(void) {
	return &activate;
}

callViewAction getViewInitActionDeactivate(void) {
	return &deactivate;
}

callViewAction getViewInitActionUpdate(void) {
	return &update;
}
